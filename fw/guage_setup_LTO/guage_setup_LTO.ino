...
/*
  ...
  and LTO HTC battery
  HTC1865
  from 1.5 V to 2.75 V

  https://files.gwl.eu/inc/_doc/attach/StoItem/4576/GWL-LTO1865-13-Spec.pdf
...
void loop()
{
  ...
  */
  ...
  Serial.print("Voltage T1-T2: ");
  Serial.println(ReadFlashByte(48,17)*256 + ReadFlashByte(48,18));
  Serial.print("Voltage T2-T3: ");
  Serial.println(ReadFlashByte(48,19)*256 + ReadFlashByte(48,20));
  Serial.print("Voltage T3-T3: ");
  Serial.println(ReadFlashByte(48,21)*256 + ReadFlashByte(48,22));
  ...
  WriteFlashByte(48,17,0x0a);    // Battery charge voltage 2600 mV = 0x0a28, 2750 mV = 0x0abe (default 4200 mV)
  WriteFlashByte(48,18,0x28);   
  WriteFlashByte(48,19,0x0a);    // Battery charge voltage 2600 mV = 0x0a28 (default 4200 mV)
  WriteFlashByte(48,20,0x28);   
  WriteFlashByte(48,21,0x0a);    // Battery charge voltage 2600 mV = 0x0a28 (default 4200 mV)
  WriteFlashByte(48,22,0x28);   

  WriteFlashByte(64,5,0x10);    // Battery Low voltage ALERT
  WriteFlashByte(64,6,0x00);   
  WriteFlashByte(49,8,0x05);    // Battery set low voltage threshold 1500 mV = 0x05dc (default 0 mV = 0x0000)
  WriteFlashByte(49,9,0xdc);   
  WriteFlashByte(49,11,0x07);   // Battery clear low voltage threshold 1850 mV = 0x073a (default 5 mV = 0x0005)
  WriteFlashByte(49,12,0x3a);
